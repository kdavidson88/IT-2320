...
/*var games = 
{
	new Library.Game("Mass Effect, ", "Third-Person Shooter, ", "March 6, 2012, ", "Shepard, ", "Pistol");
	new Library.Game("Resident Evil, ", "Third-Person Shooter, ", "March 22, 1996, ", "Chris Redfield, ", "Pistol");
	new Library.Game("Halo, ", "First-Person Shooter, ", "November 15, 2001, ", "Master Chief, ", "Rifle");
	new Library.Game("The Legend of Zelda: OOT, ", "Action-Adventure, ", "February 21, 1986, ", "Link, ", "Sword");
	new Library.Game("Super Smash Brothers, ", "Brawler, ", "January 21, 1999, ", "Nintendo Characters, ", "Variety");
	new Library.Game("Final Fantasy 7, ", "Role-Playing Game, ", "January 31, 1997, ", "Cloud Strife, ", "Buster Sword");
};
